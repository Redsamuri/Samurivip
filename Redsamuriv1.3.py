...
ki = LINETCR.LINE()
ki.login(token="EqpG57NbClvyxA2jsV4c.uPdNitA/OQwWTtSMH4Q6da.XSzO6JY3Fyy4Zl6tRuQhkFTDBTrpxmmS4kkyHKDV5AI=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqpIEsc8V5CIkvbHYqk3.TAVOkm2wqPizxdXz1JiGmW.K40rS8y4sgAaTwmiAJrLn9C0r3pgPkU5aRSOyKEmVQU=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EqcvWxSWkZLXvNuO60S3.FXP8F/ZJ0UQHfIxYmKf0iW.zVXWYhHzAUu3+pcJ0cImPjX9peYm+h/P5+1r29K3m5Y=")
ki3.loginResult()
...
owner =["u9f85803bded7abba7b0f5e11fe6dfbf8"]
admin =["u9f85803bded7abba7b0f5e11fe6dfbf8"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Redsamuri Team Mau Bersih² Group Sampah Nih")
                    msg.contentType = 13
...
#-----------------------------------------------
                ...
                ki2.sendText(msg.to,"มีหมดทั้งมุขทั้งแคปชงแคปชั่น")
                ki3.sendText(msg.to,"ไอกีไลน์👉@botnoi👈")
            elif msg.text in ["นับ1-100","นับเลข"]:
                ki.sendText(msg.to,"ตูเป็นบอทป้องกันนะ")
                ki2.sendText(msg.to,"ไม่ใช่บอทเล่นตลก")
                ki3.sendText(msg.to,"เดะปั๊ดตบหัวทิ่ม")
            elif msg.text in ["สวย","น่ารัก","จีบ"]:
                ki.sendText(msg.to,"สะดุดตา นับตั้งแต่ เมื่อแรกพบ")
                ki2.sendText(msg.to,"อยากจะคบ นับตั้งแต่ เมื่อแรกเห็น")
                ki3.sendText(msg.to,"อยากได้น้อง มาเคียงข้าง ตัวเป็นๆ")
                cl.sendText(msg.to,"แม่เนื้อเย็น พี่รักเจ้า จนหมดใจ😬😬")
            elif msg.text in ["แคปชั่น"]:
                ki.sendText(msg.to,"ถึงหน้าตาจะไม่หล่อ")
                ki2.sendText(msg.to,"แต่ถ้าลองคบแล้วน้องจะติดใจ")
                ki3.sendText(msg.to,"อ๊วกแพพ...😂😂")
            elif msg.text in ["รับแขก"]:
                ki.sendText(msg.to,"สวัสดีคับคนมาใหม่")
                ki2.sendText(msg.to,"มาใหม่แก้ผ้าด้วยนะ555+!")
                ki3.sendText(msg.to,"😄😄😄😄😄😄😄😄")
#-----------------------------------------------
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"PONG 􀨁??double thumbs up􏿿􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
      #-------------ข้อความทักทาย Start---------------------#
                ...
                ki2.sendText(msg.to,"หวัดดีแอด")
                ki3.sendText(msg.to,"หวัดดีรอง")
                cl.sendText(msg.to,"ฝากเนื้อฝากตัวด้วยนะทุกคน..😉😉")
      #-------------ข้ออความทักทาย Finish---------------------#
 
      #-------------ข้อความ Respon Start---------------------#
            elif msg.text in ["Absen","respon","เชคบอท","Respon"]:
              #if msg.from_ in admin:
                cl.sendText(msg.to,"เซลบอท On")
                ki.sendText(msg.to,"คิก1 On")
                ki2.sendText(msg.to,"คิก2 On")
                ki3.sendText(msg.to,"คิก3 On")
                cl.sendText(msg.to,"Redsamuribotอยู่ครบ\nพร้อมรับคำสั่ง!!\nมีอะไรให้รับใช้เชิญสั่งการได้เลยคับนายหัว👍")
      #-------------ข้ออความ Respon Finish---------------------#                      
      ...
      #-------------Redsamuri Speedbot Finish---------------------#

      #-------------Fungsi Banned Send Contact Start------------------#
            elif msg.text in ["Ban"]:
              #if msg.from_ in admin:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"ส่งคท.มา")
                #ki.sendText(msg.to,"Kirim contact")
                #k2.sendText(msg.to,"Kirim contact")
                #ki3.sendText(msg.to,"Kirim contact")
            elif msg.text in ["Unban"]:
              #if msg.from_ in admin:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"ส่งคท.ด้วยคับ")
                #ki.sendText(msg.to,"Kirim contact")
                #k2.sendText(msg.to,"Kirim contact")
                #k3.sendText(msg.to,"Kirim contact")
      ...
      #-----------------------------------------------
            elif msg.text in ["Happy birthday","วันเกิด","เบิร์ดเดย์"]:
                ki.sendText(msg.to,"แฮปปี้เบิร์ดเดย์")
                ki2.sendText(msg.to,"เฮฮาสุขสันต์")
                ki3.sendText(msg.to,"ทุกเมื่อเชื่อวัน")
                cl.sendText(msg.to,"สุขสันต์ สุขขี")
                ki.sendText(msg.to,"By.ป๊าเรส ผู้สร้างRedsamuribot")           
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Koplaxs⭐⭐👈\n\n™By ✰Ŕèďśámúŕi✰")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Red⭐⭐👈\n\n™By ✰Ŕèďśámúŕi✰")
                    ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Red⭐⭐👈\n\n™By ✰Ŕèďśámúŕi✰")
                    ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Red⭐⭐👈\n\n™By ✰Ŕèďśámúŕi✰")
                    print "Like"
                except:
                    pass
            else:
